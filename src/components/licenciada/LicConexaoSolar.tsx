...
const LicConexaoSolar = () => (
  <section>
    <div className="section-container">
      ...
      <img src="/images/feed-1.jpeg" alt="Conexão Solar" loading="lazy" className="rounded-xl w-full max-w-2xl mx-auto mb-12 shadow-lg" style={{ boxShadow: 'var(--shadow-card)' }} />
